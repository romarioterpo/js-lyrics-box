...
function searchQuery() {
  ...
  const url = `${apiURL}/suggest/${query}`;
...
function showSearchError() {
  searchResultsContainer.html("Request error, please try again");
}

function showLyricsError() {
  lyricsResultsContainer.html("No Lyrics Found");
}
